...
//    if($stopWatch_obj->running){echo "kokot";}

 //if(isset($_POST['pause'])) echo $stopWatch_obj->running;
    ...
    <html lang="en">
        ...
        <div class="row w-50 mx-auto mt-5">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <button type="submit" name="start" class="btn btn-success mt-5 ml-5">
                    <i class="fa fa-play fa-lg"></i> Start
                </button>
            </form>

            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <button type="submit" name="pause" class="btn btn-success mt-5 ml-5">
                    <i class="fa fa-pause fa-lg"></i> Pause
                </button>
            </form>

            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                <button type="submit" name="reset" class="btn btn-success mt-5 ml-5">
